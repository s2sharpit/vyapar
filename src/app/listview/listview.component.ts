...
@Component({
  ...
  template: `
    <main class="grid gap-4">
      <h3 class="text-primary text-xl font-medium pb-1 border-b capitalize">{{ headerVal }}</h3>
      <form class="flex bg-secondary rounded-full overflow-hidden px-4 items-center gap-2">
      ...
      <section class="bg-secondary divide-y-2 divide-background rounded-2xl">
